...
# --- ප්‍රශ්න 20 කට්ටලය (නිවැරදි කරන ලදි) ---
...
if st.session_state.q_no < len(st.session_state.questions):
    ...
    if st.session_state.status == "boxes":
        ...
        st.error("අපොයි! මේ කොටුවේ ප්‍රශ්නය නැහැ. ලකුණු හිමිවන්නේ නැත. ❌")
        ...
        answer = st.radio("නිවැරදි පිළිතුර තෝරන්න:", current_q['o'], index=None)
